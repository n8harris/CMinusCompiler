...
(FUNCTION  printInt  [(int r)]
  ...
  (BB 11
    ...
    (OPER 52 BEQ []  [(r 30)(i 0)(bb 13)])
  )
  (BB 12
    (OPER 53 Mov [(r 31)]  [(i 0)])
    (OPER 54 Pass []  [(r 31)])
    (OPER 55 JSR []  [(s putDigit)])
  ...
  (BB 16
    ...
    (OPER 73 BEQ []  [(r 42)(i 0)(bb 18)])
  )
  (BB 17
    (OPER 74 Mov [(r 43)]  [(i 0)])
    (OPER 75 Pass []  [(r 43)])
...
(FUNCTION  main  []
  ...
  (BB 9
    ...
    (OPER 107 BEQ []  [(r 61)(i 0)(bb 12)])
  )
  (BB 10
    (OPER 108 Mov [(r 62)]  [(i 0)])
    (OPER 109 EQ [(r 63)]  [(r 2)(r 62)])
    (OPER 110 BEQ []  [(r 63)(i 0)(bb 15)])
  )
  (BB 13
